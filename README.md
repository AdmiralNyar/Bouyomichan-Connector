...
- CoeFontのAPIはEnterprise契約のみ利用可能となり、対応の確認できなくなっております。Foundry VTT Version11対応時に機能を削除予定としております。
　<br>
　<br>
　<br>
## 使用方法
...
　<br>
　<br>
2. VOICEVOX[^9]、LMROID、SHAREVOX、COEIROINK[^10]onVOICEVOXの場合
...
　<br>
　<br>
4. VOICEPEAK[^12]の場合（連携できません。棒読みちゃんと連携する方法をご存じの方がいましたら情報提供ください）
　<br>
　<br>
5. CeVIO[^13]\(CS6のみ)
...
[^9]:VOICEVOXは商標出願中です（出願日：2022/6/5）。
[^10]:COEIROINKは商標出願中です（出願日：2022/5/25）。
[^11]:AIVoiceは株式会社エーアイの登録商標です。
[^12]:VOICEPEAKはDreamTonics株式会社の登録商標です。
[^13]:CeVIOは株式会社フロンティアワークスの登録商標です。
